...
format:
	dotnet tool run dotnet-format -w -s error Source/Dafny.sln --exclude DafnyCore/Scanner.cs --exclude DafnyCore/Parser.cs --exclude DafnyCore/DafnyGeneratedFromDafny.cs --exclude DafnyCore/DafnyGeneratedFromDafnyRust.cs

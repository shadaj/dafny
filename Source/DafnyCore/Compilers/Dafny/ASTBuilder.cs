...
namespace Microsoft.Dafny.Compilers {
  ...
  interface NewtypeContainer {
    ...
    public NewtypeBuilder Newtype(string name, DAST.Type baseType, bool isNumeric, List<DAST.Statement> witnessStmts, DAST.Expression witness) {
      return new NewtypeBuilder(this, name, baseType, isNumeric, witnessStmts, witness);
    }
  }
  ...
  class NewtypeBuilder : ClassLike {
    ...
    public NewtypeBuilder(NewtypeContainer parent, string name, DAST.Type baseType, bool isNumeric, List<DAST.Statement> statements, DAST.Expression witness) {
      this.parent = parent;
      this.name = name;

  ...
  public partial class COMP {
      ...
      if (_source15.is_DeclareVar) {
        ...
        DAST._IExpression _271_on = _262___mcc_h11;
        {
          ...
          if (_source17.is_Literal) {
            ...
            bool _311___mcc_h68 = _source17.dtor_onDatatype;
            {
              _281_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _281_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source17.is_SelectFn) {
            DAST._IExpression _312___mcc_h72 = _source17.dtor_expr;
            Dafny.ISequence<Dafny.Rune> _313___mcc_h73 = _source17.dtor_field;
            bool _314___mcc_h74 = _source17.dtor_onDatatype;
            bool _315___mcc_h75 = _source17.dtor_isStatic;
            BigInteger _316___mcc_h76 = _source17.dtor_arity;
            {
              _281_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _281_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source17.is_TupleSelect) {
            DAST._IExpression _317___mcc_h82 = _source17.dtor_expr;
            BigInteger _318___mcc_h83 = _source17.dtor_index;
            {
              _281_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _281_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source17.is_Call) {
            DAST._IExpression _319___mcc_h86 = _source17.dtor_on;
            Dafny.ISequence<Dafny.Rune> _320___mcc_h87 = _source17.dtor_name;
            Dafny.ISequence<DAST._IType> _321___mcc_h88 = _source17.dtor_typeArgs;
            Dafny.ISequence<DAST._IExpression> _322___mcc_h89 = _source17.dtor_args;
            {
              _281_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _281_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source17.is_Lambda) {
            Dafny.ISequence<DAST._IFormal> _323___mcc_h94 = _source17.dtor_params;
            DAST._IType _324___mcc_h95 = _source17.dtor_retType;
            Dafny.ISequence<DAST._IStatement> _325___mcc_h96 = _source17.dtor_body;
            {
              _281_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _281_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source17.is_IIFE) {
            Dafny.ISequence<Dafny.Rune> _326___mcc_h100 = _source17.dtor_name;
            DAST._IType _327___mcc_h101 = _source17.dtor_typ;
            DAST._IExpression _328___mcc_h102 = _source17.dtor_value;
            DAST._IExpression _329___mcc_h103 = _source17.dtor_iifeBody;
            {
              _281_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _281_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source17.is_Apply) {
            DAST._IExpression _330___mcc_h108 = _source17.dtor_expr;
            Dafny.ISequence<DAST._IExpression> _331___mcc_h109 = _source17.dtor_args;
            {
              _281_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _281_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source17.is_TypeTest) {
            DAST._IExpression _332___mcc_h112 = _source17.dtor_on;
            Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _333___mcc_h113 = _source17.dtor_dType;
            Dafny.ISequence<Dafny.Rune> _334___mcc_h114 = _source17.dtor_variant;
            {
              _281_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _281_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else {
            DAST._IType _335___mcc_h118 = _source17.dtor_typ;
            {
              _281_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _281_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          }
          Dafny.ISequence<Dafny.Rune> _336_receiver;
          _336_receiver = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("");
          DAST._IOptional<Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>> _source18 = _267_maybeOutVars;
          if (_source18.is_Some) {
            Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _337___mcc_h120 = _source18.dtor_Some_a0;
            Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _338_outVars = _337___mcc_h120;
            {
              if ((new BigInteger((_338_outVars).Count)) > (BigInteger.One)) {
                _336_receiver = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(");
              }
              BigInteger _339_outI;
              _339_outI = BigInteger.Zero;
              while ((_339_outI) < (new BigInteger((_338_outVars).Count))) {
                if ((_339_outI).Sign == 1) {
                  _336_receiver = Dafny.Sequence<Dafny.Rune>.Concat(_336_receiver, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", "));
                }
                Dafny.ISequence<Dafny.Rune> _340_outVar;
                _340_outVar = (_338_outVars).Select(_339_outI);
                _336_receiver = Dafny.Sequence<Dafny.Rune>.Concat(_336_receiver, (_340_outVar));
                _339_outI = (_339_outI) + (BigInteger.One);
              }
              if ((new BigInteger((_338_outVars).Count)) > (BigInteger.One)) {
                _336_receiver = Dafny.Sequence<Dafny.Rune>.Concat(_336_receiver, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
              }
          ...
          generated = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(((!(_336_receiver).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(""))) ? (Dafny.Sequence<Dafny.Rune>.Concat(_336_receiver, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" = "))) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString(""))), _281_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("r#")), _270_name), _272_typeArgString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(")), _275_argString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(");"));
        }
      } else if (_source15.is_Return) {
        DAST._IExpression _341___mcc_h16 = _source15.dtor_expr;
        DAST._IExpression _342_expr = _341___mcc_h16;
        {
          Dafny.ISequence<Dafny.Rune> _343_exprString;
          bool _344___v21;
          bool _345_recErased;
          ...
          DCOMP.COMP.GenExpr(_342_expr, @params, true, out _out101, out _out102, out _out103, out _out104);
          _343_exprString = _out101;
          _344___v21 = _out102;
          _345_recErased = _out103;
          _346_recIdents = _out104;
          _343_exprString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyUnerasable::<_>::unerase_owned("), _343_exprString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
          readIdents = _346_recIdents;
          if (isLast) {
            generated = _343_exprString;
          } else {
            generated = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("return "), _343_exprString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(";"));
          }
        }
        ...
        DAST._IExpression _347___mcc_h17 = _source15.dtor_Print_a0;
        DAST._IExpression _348_e = _347___mcc_h17;
        {
          Dafny.ISequence<Dafny.Rune> _349_printedExpr;
          bool _350_isOwned;
          bool _351___v22;
          ...
          DCOMP.COMP.GenExpr(_348_e, @params, false, out _out105, out _out106, out _out107, out _out108);
          _349_printedExpr = _out105;
          _350_isOwned = _out106;
          _351___v22 = _out107;
          _352_recIdents = _out108;
          generated = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("print!(\"{}\", ::dafny_runtime::DafnyPrintWrapper("), ((_350_isOwned) ? (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&")) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")))), _349_printedExpr), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("));"));
    ...
    public static void GenExpr(DAST._IExpression e, Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> @params, bool mustOwn, out Dafny.ISequence<Dafny.Rune> s, out bool isOwned, out bool isErased, out Dafny.ISet<Dafny.ISequence<Dafny.Rune>> readIdents) {
      ...
      if (_source19.is_Literal) {
        DAST._ILiteral _353___mcc_h0 = _source19.dtor_Literal_a0;
        DAST._ILiteral _source20 = _353___mcc_h0;
        if (_source20.is_BoolLiteral) {
          bool _354___mcc_h1 = _source20.dtor_BoolLiteral_a0;
          if ((_354___mcc_h1) == (false)) {
            {
          ...
          BigInteger _355___mcc_h2 = _source20.dtor_IntLiteral_a0;
          BigInteger _356_i = _355___mcc_h2;
          {
            if ((_356_i).Sign == -1) {
              s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("-"), DCOMP.__default.natToString((BigInteger.Zero) - (_356_i)));
            } else {
              s = DCOMP.__default.natToString(_356_i);
            }
            isOwned = true;
            isErased = true;
            readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements();
          ...
          Dafny.ISequence<Dafny.Rune> _357___mcc_h3 = _source20.dtor_DecLiteral_a0;
          Dafny.ISequence<Dafny.Rune> _358_l = _357___mcc_h3;
          {
            s = _358_l;
            isOwned = true;
            isErased = true;
          ...
          Dafny.ISequence<Dafny.Rune> _359___mcc_h4 = _source20.dtor_StringLiteral_a0;
          Dafny.ISequence<Dafny.Rune> _360_l = _359___mcc_h4;
          {
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\""), _360_l), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\".chars().collect::<Vec<char>>()"));
            isOwned = true;
            isErased = true;
            readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements();
          }
        } else if (_source20.is_CharLiteral) {
          Dafny.Rune _361___mcc_h5 = _source20.dtor_CharLiteral_a0;
          Dafny.Rune _362_c = _361___mcc_h5;
          {
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::std::primitive::char::from_u32("), DCOMP.__default.natToString(new BigInteger((_362_c).Value))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(").unwrap()"));
            isOwned = true;
            isErased = true;
            readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements();
          }
        ...
        Dafny.ISequence<Dafny.Rune> _363___mcc_h6 = _source19.dtor_Ident_a0;
        Dafny.ISequence<Dafny.Rune> _364_name = _363___mcc_h6;
        {
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("r#"), _364_name);
          if (!((@params).Contains(_364_name))) {
          ...
          isErased = false;
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements(_364_name);
        }
      } else if (_source19.is_Companion) {
        Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _365___mcc_h7 = _source19.dtor_Companion_a0;
        Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _366_path = _365___mcc_h7;
        {
          Dafny.ISequence<Dafny.Rune> _out109;
          _out109 = DCOMP.COMP.GenPath(_366_path);
          s = _out109;
          isOwned = true;
          isErased = true;
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements();
        ...
        Dafny.ISequence<DAST._IExpression> _367___mcc_h8 = _source19.dtor_Tuple_a0;
        Dafny.ISequence<DAST._IExpression> _368_values = _367___mcc_h8;
        {
          s = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(");
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements();
          BigInteger _369_i;
          ...
          bool _370_allErased;
          _370_allErased = true;
          while ((_369_i) < (new BigInteger((_368_values).Count))) {
            Dafny.ISequence<Dafny.Rune> _371___v23;
            bool _372___v24;
            bool _373_isErased;
            Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _374___v25;
            Dafny.ISequence<Dafny.Rune> _out110;
            bool _out111;
            bool _out112;
            Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _out113;
            DCOMP.COMP.GenExpr((_368_values).Select(_369_i), @params, true, out _out110, out _out111, out _out112, out _out113);
            _371___v23 = _out110;
            _372___v24 = _out111;
            _373_isErased = _out112;
            _374___v25 = _out113;
            _370_allErased = (_370_allErased) && (_373_isErased);
          ...
          while ((_369_i) < (new BigInteger((_368_values).Count))) {
            ...
            DCOMP.COMP.GenExpr((_368_values).Select(_369_i), @params, true, out _out114, out _out115, out _out116, out _out117);
            _375_recursiveGen = _out114;
            _376___v26 = _out115;
            _377_isErased = _out116;
            _378_recIdents = _out117;
            if ((_377_isErased) && (!(_370_allErased))) {
            ...
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(s, _375_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(","));
            readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(readIdents, _378_recIdents);
            _369_i = (_369_i) + (BigInteger.One);
          }
          s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
          isOwned = true;
          isErased = _370_allErased;
        }
      } else if (_source19.is_New) {
        Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _379___mcc_h9 = _source19.dtor_path;
        Dafny.ISequence<DAST._IExpression> _380___mcc_h10 = _source19.dtor_args;
        Dafny.ISequence<DAST._IExpression> _381_args = _380___mcc_h10;
        Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _382_path = _379___mcc_h9;
        {
          Dafny.ISequence<Dafny.Rune> _383_path;
          Dafny.ISequence<Dafny.Rune> _out118;
          _out118 = DCOMP.COMP.GenPath(_382_path);
          _383_path = _out118;
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::std::rc::Rc::new("), _383_path), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::new("));
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements();
          BigInteger _384_i;
          _384_i = BigInteger.Zero;
          while ((_384_i) < (new BigInteger((_381_args).Count))) {
            if ((_384_i).Sign == 1) {
              s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", "));
            }
            ...
            DCOMP.COMP.GenExpr((_381_args).Select(_384_i), @params, true, out _out119, out _out120, out _out121, out _out122);
            _385_recursiveGen = _out119;
            _386___v27 = _out120;
            _387_isErased = _out121;
            _388_recIdents = _out122;
            if (_387_isErased) {
              _385_recursiveGen = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyUnerasable::<_>::unerase_owned("), _385_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
            }
            s = Dafny.Sequence<Dafny.Rune>.Concat(s, _385_recursiveGen);
            readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(readIdents, _388_recIdents);
            _384_i = (_384_i) + (BigInteger.One);
          }
          s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("))"));
          isOwned = true;
          isErased = true;
        ...
        Dafny.ISequence<DAST._IExpression> _389___mcc_h11 = _source19.dtor_dims;
        Dafny.ISequence<DAST._IExpression> _390_dims = _389___mcc_h11;
        {
          BigInteger _391_i;
          _391_i = (new BigInteger((_390_dims).Count)) - (BigInteger.One);
          ...
          while ((_391_i).Sign != -1) {
            ...
            DCOMP.COMP.GenExpr((_390_dims).Select(_391_i), @params, true, out _out123, out _out124, out _out125, out _out126);
            _392_recursiveGen = _out123;
            _393___v28 = _out124;
            _394_isErased = _out125;
            _395_recIdents = _out126;
            if (!(_394_isErased)) {
              _392_recursiveGen = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyErasable::erase_owned("), _392_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
            }
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("vec!["), s), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("; (")), _392_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(") as usize]"));
            readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(readIdents, _395_recIdents);
            _391_i = (_391_i) - (BigInteger.One);
          }
          isOwned = true;
          isErased = true;
        }
      } else if (_source19.is_DatatypeValue) {
        Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _396___mcc_h12 = _source19.dtor_path;
        Dafny.ISequence<Dafny.Rune> _397___mcc_h13 = _source19.dtor_variant;
        bool _398___mcc_h14 = _source19.dtor_isCo;
        Dafny.ISequence<_System._ITuple2<Dafny.ISequence<Dafny.Rune>, DAST._IExpression>> _399___mcc_h15 = _source19.dtor_contents;
        Dafny.ISequence<_System._ITuple2<Dafny.ISequence<Dafny.Rune>, DAST._IExpression>> _400_values = _399___mcc_h15;
        bool _401_isCo = _398___mcc_h14;
        Dafny.ISequence<Dafny.Rune> _402_variant = _397___mcc_h13;
        Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _403_path = _396___mcc_h12;
        {
          Dafny.ISequence<Dafny.Rune> _404_path;
          Dafny.ISequence<Dafny.Rune> _out127;
          _out127 = DCOMP.COMP.GenPath(_403_path);
          _404_path = _out127;
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::std::rc::Rc::new("), _404_path), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::r#")), _402_variant);
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements();
          BigInteger _405_i;
          _405_i = BigInteger.Zero;
          s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" {"));
          while ((_405_i) < (new BigInteger((_400_values).Count))) {
            _System._ITuple2<Dafny.ISequence<Dafny.Rune>, DAST._IExpression> _let_tmp_rhs0 = (_400_values).Select(_405_i);
            Dafny.ISequence<Dafny.Rune> _406_name = _let_tmp_rhs0.dtor__0;
            DAST._IExpression _407_value = _let_tmp_rhs0.dtor__1;
            if ((_405_i).Sign == 1) {
              s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", "));
            }
            if (_401_isCo) {
              Dafny.ISequence<Dafny.Rune> _408_recursiveGen;
              bool _409___v29;
              bool _410_isErased;
              ...
              DCOMP.COMP.GenExpr(_407_value, Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(), true, out _out128, out _out129, out _out130, out _out131);
              _408_recursiveGen = _out128;
              _409___v29 = _out129;
              _410_isErased = _out130;
              _411_recIdents = _out131;
              if (!(_410_isErased)) {
                _408_recursiveGen = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyErasable::erase_owned("), _408_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
              }
              _408_recursiveGen = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyUnerasable::<_>::unerase_owned("), _408_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
              readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(readIdents, _411_recIdents);
              Dafny.ISequence<Dafny.Rune> _412_allReadCloned;
              _412_allReadCloned = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("");
              while (!(_411_recIdents).Equals(Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements())) {
                Dafny.ISequence<Dafny.Rune> _413_next;
                foreach (Dafny.ISequence<Dafny.Rune> _assign_such_that_0 in (_411_recIdents).Elements) {
                  _413_next = (Dafny.ISequence<Dafny.Rune>)_assign_such_that_0;
                  if ((_411_recIdents).Contains(_413_next)) {
                    goto after__ASSIGN_SUCH_THAT_0;
                  }
                }
                throw new System.Exception("assign-such-that search produced no value (line 1038)");
              after__ASSIGN_SUCH_THAT_0:;
                _412_allReadCloned = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_412_allReadCloned, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("let r#")), _413_next), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" = r#")), _413_next), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(".clone();\n"));
                _411_recIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Difference(_411_recIdents, Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements(_413_next));
              }
              s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("r#")), _406_name), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(": ::dafny_runtime::LazyFieldWrapper(::dafny_runtime::Lazy::new(::std::boxed::Box::new({\n")), _412_allReadCloned), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("move || (")), _408_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")})))"));
            } else {
              ...
              DCOMP.COMP.GenExpr(_407_value, @params, true, out _out132, out _out133, out _out134, out _out135);
              _414_recursiveGen = _out132;
              _415___v30 = _out133;
              _416_isErased = _out134;
              _417_recIdents = _out135;
              if (!(_416_isErased)) {
                _414_recursiveGen = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyErasable::erase_owned("), _414_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
              }
              ...
              s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("r#")), _406_name), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(": ")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(")), _414_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
        ...
        DAST._IExpression _418___mcc_h16 = _source19.dtor_value;
        DAST._IType _419___mcc_h17 = _source19.dtor_typ;
        DAST._IType _420_tpe = _419___mcc_h17;
        DAST._IExpression _421_expr = _418___mcc_h16;
        {
          Dafny.ISequence<Dafny.Rune> _422_tpeGen;
          Dafny.ISequence<Dafny.Rune> _out136;
          _out136 = DCOMP.COMP.GenType(_420_tpe, true, false);
          _422_tpeGen = _out136;
          ...
          DCOMP.COMP.GenExpr(_421_expr, @params, false, out _out137, out _out138, out _out139, out _out140);
          _423_recursiveGen = _out137;
          _424_recOwned = _out138;
          _425_recErased = _out139;
          _426_recIdents = _out140;
          Dafny.ISequence<Dafny.Rune> _427_uneraseFn;
          _427_uneraseFn = ((_424_recOwned) ? (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("unerase_owned")) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("unerase")));
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("<"), _422_tpeGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" as ::dafny_runtime::DafnyUnerasable<_>>::")), _427_uneraseFn), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(")), _423_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
          isOwned = _424_recOwned;
          isErased = false;
          readIdents = _426_recIdents;
        }
      } else if (_source19.is_SubsetDowngrade) {
        DAST._IExpression _428___mcc_h18 = _source19.dtor_value;
        DAST._IExpression _429_expr = _428___mcc_h18;
        {
          ...
          DCOMP.COMP.GenExpr(_429_expr, @params, false, out _out141, out _out142, out _out143, out _out144);
          _430_recursiveGen = _out141;
          _431_recOwned = _out142;
          _432_recErased = _out143;
          _433_recIdents = _out144;
          Dafny.ISequence<Dafny.Rune> _434_eraseFn;
          _434_eraseFn = ((_431_recOwned) ? (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("erase_owned")) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("erase")));
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyErasable::"), _434_eraseFn), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(")), _430_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
          isOwned = _431_recOwned;
          isErased = true;
          readIdents = _433_recIdents;
        }
      } else if (_source19.is_SeqValue) {
        Dafny.ISequence<DAST._IExpression> _435___mcc_h19 = _source19.dtor_elements;
        Dafny.ISequence<DAST._IExpression> _436_exprs = _435___mcc_h19;
        {
          Dafny.ISequence<_System._ITuple2<Dafny.ISequence<Dafny.Rune>, bool>> _437_generatedValues;
          _437_generatedValues = Dafny.Sequence<_System._ITuple2<Dafny.ISequence<Dafny.Rune>, bool>>.FromElements();
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements();
          BigInteger _438_i;
          _438_i = BigInteger.Zero;
          bool _439_allErased;
          _439_allErased = true;
          while ((_438_i) < (new BigInteger((_436_exprs).Count))) {
            ...
            DCOMP.COMP.GenExpr((_436_exprs).Select(_438_i), @params, true, out _out145, out _out146, out _out147, out _out148);
            _440_recursiveGen = _out145;
            _441___v31 = _out146;
            _442_isErased = _out147;
            _443_recIdents = _out148;
            _439_allErased = (_439_allErased) && (_442_isErased);
            _437_generatedValues = Dafny.Sequence<_System._ITuple2<Dafny.ISequence<Dafny.Rune>, bool>>.Concat(_437_generatedValues, Dafny.Sequence<_System._ITuple2<Dafny.ISequence<Dafny.Rune>, bool>>.FromElements(_System.Tuple2<Dafny.ISequence<Dafny.Rune>, bool>.create(_440_recursiveGen, _442_isErased)));
          ...
          _438_i = BigInteger.Zero;
          while ((_438_i) < (new BigInteger((_437_generatedValues).Count))) {
            if ((_438_i).Sign == 1) {
              s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", "));
            }
            Dafny.ISequence<Dafny.Rune> _444_gen;
            _444_gen = ((_437_generatedValues).Select(_438_i)).dtor__0;
            if ((((_437_generatedValues).Select(_438_i)).dtor__1) && (!(_439_allErased))) {
              _444_gen = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyUnerasable::<_>::unerase_owned("), _444_gen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
            }
            s = Dafny.Sequence<Dafny.Rune>.Concat(s, _444_gen);
            _438_i = (_438_i) + (BigInteger.One);
          }
          s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("]"));
          isOwned = true;
          isErased = _439_allErased;
        }
      } else if (_source19.is_SetValue) {
        Dafny.ISequence<DAST._IExpression> _445___mcc_h20 = _source19.dtor_elements;
        Dafny.ISequence<DAST._IExpression> _446_exprs = _445___mcc_h20;
        {
          Dafny.ISequence<_System._ITuple2<Dafny.ISequence<Dafny.Rune>, bool>> _447_generatedValues;
          _447_generatedValues = Dafny.Sequence<_System._ITuple2<Dafny.ISequence<Dafny.Rune>, bool>>.FromElements();
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements();
          BigInteger _448_i;
          _448_i = BigInteger.Zero;
          bool _449_allErased;
          _449_allErased = true;
          while ((_448_i) < (new BigInteger((_446_exprs).Count))) {
            ...
            DCOMP.COMP.GenExpr((_446_exprs).Select(_448_i), @params, true, out _out149, out _out150, out _out151, out _out152);
            _450_recursiveGen = _out149;
            _451___v32 = _out150;
            _452_isErased = _out151;
            _453_recIdents = _out152;
            _449_allErased = (_449_allErased) && (_452_isErased);
            _447_generatedValues = Dafny.Sequence<_System._ITuple2<Dafny.ISequence<Dafny.Rune>, bool>>.Concat(_447_generatedValues, Dafny.Sequence<_System._ITuple2<Dafny.ISequence<Dafny.Rune>, bool>>.FromElements(_System.Tuple2<Dafny.ISequence<Dafny.Rune>, bool>.create(_450_recursiveGen, _452_isErased)));
            readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(readIdents, _453_recIdents);
            _448_i = (_448_i) + (BigInteger.One);
          }
          s = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("vec![");
          _448_i = BigInteger.Zero;
          while ((_448_i) < (new BigInteger((_447_generatedValues).Count))) {
            if ((_448_i).Sign == 1) {
              s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", "));
            }
            Dafny.ISequence<Dafny.Rune> _454_gen;
            _454_gen = ((_447_generatedValues).Select(_448_i)).dtor__0;
            if ((((_447_generatedValues).Select(_448_i)).dtor__1) && (!(_449_allErased))) {
              _454_gen = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyUnerasable::<_>::unerase_owned("), _454_gen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
            }
            s = Dafny.Sequence<Dafny.Rune>.Concat(s, _454_gen);
            _448_i = (_448_i) + (BigInteger.One);
          }
        ...
        DAST._IExpression _455___mcc_h21 = _source19.dtor_cond;
        DAST._IExpression _456___mcc_h22 = _source19.dtor_thn;
        DAST._IExpression _457___mcc_h23 = _source19.dtor_els;
        DAST._IExpression _458_f = _457___mcc_h23;
        DAST._IExpression _459_t = _456___mcc_h22;
        DAST._IExpression _460_cond = _455___mcc_h21;
        {
          Dafny.ISequence<Dafny.Rune> _461_condString;
          bool _462___v33;
          bool _463_condErased;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _464_recIdentsCond;
          Dafny.ISequence<Dafny.Rune> _out153;
          bool _out154;
          bool _out155;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _out156;
          DCOMP.COMP.GenExpr(_460_cond, @params, true, out _out153, out _out154, out _out155, out _out156);
          _461_condString = _out153;
          _462___v33 = _out154;
          _463_condErased = _out155;
          _464_recIdentsCond = _out156;
          if (!(_463_condErased)) {
            _461_condString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyErasable::erase_owned("), _461_condString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
          }
          Dafny.ISequence<Dafny.Rune> _465___v34;
          bool _466_tHasToBeOwned;
          bool _467___v35;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _468___v36;
          Dafny.ISequence<Dafny.Rune> _out157;
          bool _out158;
          bool _out159;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _out160;
          DCOMP.COMP.GenExpr(_459_t, @params, mustOwn, out _out157, out _out158, out _out159, out _out160);
          _465___v34 = _out157;
          _466_tHasToBeOwned = _out158;
          _467___v35 = _out159;
          _468___v36 = _out160;
          Dafny.ISequence<Dafny.Rune> _469_fString;
          bool _470_fOwned;
          bool _471_fErased;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _472_recIdentsF;
          Dafny.ISequence<Dafny.Rune> _out161;
          bool _out162;
          bool _out163;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _out164;
          DCOMP.COMP.GenExpr(_458_f, @params, _466_tHasToBeOwned, out _out161, out _out162, out _out163, out _out164);
          _469_fString = _out161;
          _470_fOwned = _out162;
          _471_fErased = _out163;
          _472_recIdentsF = _out164;
          Dafny.ISequence<Dafny.Rune> _473_tString;
          bool _474___v37;
          bool _475_tErased;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _476_recIdentsT;
          Dafny.ISequence<Dafny.Rune> _out165;
          bool _out166;
          bool _out167;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _out168;
          DCOMP.COMP.GenExpr(_459_t, @params, _470_fOwned, out _out165, out _out166, out _out167, out _out168);
          _473_tString = _out165;
          _474___v37 = _out166;
          _475_tErased = _out167;
          _476_recIdentsT = _out168;
          if ((!(_471_fErased)) || (!(_475_tErased))) {
            if (_471_fErased) {
              _469_fString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyErasable::erase_owned("), _469_fString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
            }
            if (_475_tErased) {
              _473_tString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyErasable::erase_owned("), _473_tString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
            }
          }
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(if "), _461_condString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" {\n")), _473_tString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n} else {\n")), _469_fString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n})"));
          isOwned = _470_fOwned;
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(_464_recIdentsCond, _476_recIdentsT), _472_recIdentsF);
          isErased = (_471_fErased) || (_475_tErased);
        }
      } else if (_source19.is_UnOp) {
        DAST._IUnaryOp _477___mcc_h24 = _source19.dtor_unOp;
        DAST._IExpression _478___mcc_h25 = _source19.dtor_expr;
        DAST._IUnaryOp _source21 = _477___mcc_h24;
        if (_source21.is_Not) {
          DAST._IExpression _479_e = _478___mcc_h25;
          {
            ...
            DCOMP.COMP.GenExpr(_479_e, @params, true, out _out169, out _out170, out _out171, out _out172);
            _480_recursiveGen = _out169;
            _481___v38 = _out170;
            _482_recErased = _out171;
            _483_recIdents = _out172;
            if (!(_482_recErased)) {
            ...
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("!("), _480_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
            isOwned = true;
            readIdents = _483_recIdents;
            isErased = true;
          }
        } else if (_source21.is_BitwiseNot) {
          DAST._IExpression _484_e = _478___mcc_h25;
          {
            ...
            DCOMP.COMP.GenExpr(_484_e, @params, true, out _out173, out _out174, out _out175, out _out176);
            ...
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("~("), _485_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
            isOwned = true;
            readIdents = _488_recIdents;
            isErased = true;
          }
        } else {
          DAST._IExpression _489_e = _478___mcc_h25;
          {
            ...
            DCOMP.COMP.GenExpr(_489_e, @params, false, out _out177, out _out178, out _out179, out _out180);
            _490_recursiveGen = _out177;
            _491___v40 = _out178;
            _492_recErased = _out179;
            _493_recIdents = _out180;
            if (!(_492_recErased)) {
              _490_recursiveGen = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyErasable::erase_owned("), _490_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
            }
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _490_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(").len()"));
            isOwned = true;
        ...
        Dafny.ISequence<Dafny.Rune> _494___mcc_h26 = _source19.dtor_op;
        DAST._IExpression _495___mcc_h27 = _source19.dtor_left;
        DAST._IExpression _496___mcc_h28 = _source19.dtor_right;
        DAST._IExpression _497_r = _496___mcc_h28;
        DAST._IExpression _498_l = _495___mcc_h27;
        Dafny.ISequence<Dafny.Rune> _499_op = _494___mcc_h26;
        {
          Dafny.ISequence<Dafny.Rune> _500_left;
          bool _501___v41;
          bool _502_leftErased;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _503_recIdentsL;
          Dafny.ISequence<Dafny.Rune> _out181;
          bool _out182;
          bool _out183;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _out184;
          DCOMP.COMP.GenExpr(_498_l, @params, true, out _out181, out _out182, out _out183, out _out184);
          _500_left = _out181;
          _501___v41 = _out182;
          _502_leftErased = _out183;
          _503_recIdentsL = _out184;
          Dafny.ISequence<Dafny.Rune> _504_right;
          bool _505___v42;
          bool _506_rightErased;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _507_recIdentsR;
          Dafny.ISequence<Dafny.Rune> _out185;
          bool _out186;
          bool _out187;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _out188;
          DCOMP.COMP.GenExpr(_497_r, @params, true, out _out185, out _out186, out _out187, out _out188);
          _504_right = _out185;
          _505___v42 = _out186;
          _506_rightErased = _out187;
          _507_recIdentsR = _out188;
          if (!(_502_leftErased)) {
            _500_left = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyErasable::erase_owned("), _500_left), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
          }
          if (!(_506_rightErased)) {
            _504_right = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyErasable::erase_owned("), _504_right), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
          }
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _500_left), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" ")), _499_op), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" ")), _504_right), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
          isOwned = true;
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(_503_recIdentsL, _507_recIdentsR);
          isErased = true;
        }
      } else if (_source19.is_Select) {
        DAST._IExpression _508___mcc_h29 = _source19.dtor_expr;
        Dafny.ISequence<Dafny.Rune> _509___mcc_h30 = _source19.dtor_field;
        bool _510___mcc_h31 = _source19.dtor_onDatatype;
        bool _511_isDatatype = _510___mcc_h31;
        Dafny.ISequence<Dafny.Rune> _512_field = _509___mcc_h30;
        DAST._IExpression _513_on = _508___mcc_h29;
        {
          Dafny.ISequence<Dafny.Rune> _514_onString;
          bool _515_onOwned;
          bool _516_onErased;
          ...
          DCOMP.COMP.GenExpr(_513_on, @params, false, out _out189, out _out190, out _out191, out _out192);
          _514_onString = _out189;
          _515_onOwned = _out190;
          _516_onErased = _out191;
          _517_recIdents = _out192;
          if (!(_516_onErased)) {
            Dafny.ISequence<Dafny.Rune> _518_eraseFn;
            _518_eraseFn = ((_515_onOwned) ? (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("erase_owned")) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("erase")));
            _514_onString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyErasable::"), _518_eraseFn), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(")), _514_onString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
          }
          if (_511_isDatatype) {
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _514_onString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(".r#")), _512_field), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("()"));
            if (mustOwn) {
            ...
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::std::ops::Deref::deref(&(("), _514_onString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(".r#")), _512_field), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(".borrow()))"));
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), s), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(").clone()"));
            isOwned = true;
          }
          isErased = false;
        ...
        DAST._IExpression _519___mcc_h32 = _source19.dtor_expr;
        Dafny.ISequence<Dafny.Rune> _520___mcc_h33 = _source19.dtor_field;
        bool _521___mcc_h34 = _source19.dtor_onDatatype;
        bool _522___mcc_h35 = _source19.dtor_isStatic;
        BigInteger _523___mcc_h36 = _source19.dtor_arity;
        BigInteger _524_arity = _523___mcc_h36;
        bool _525_isStatic = _522___mcc_h35;
        bool _526_isDatatype = _521___mcc_h34;
        Dafny.ISequence<Dafny.Rune> _527_field = _520___mcc_h33;
        DAST._IExpression _528_on = _519___mcc_h32;
        {
          Dafny.ISequence<Dafny.Rune> _529_onString;
          bool _530_onOwned;
          bool _531___v43;
          ...
          DCOMP.COMP.GenExpr(_528_on, @params, false, out _out193, out _out194, out _out195, out _out196);
          _529_onString = _out193;
          _530_onOwned = _out194;
          _531___v43 = _out195;
          _532_recIdents = _out196;
          if (_525_isStatic) {
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_529_onString, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::")), _527_field);
          } else {
            s = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("{\n");
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("let callTarget = (")), _529_onString), ((_530_onOwned) ? (Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")")) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString(").clone()")))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(";\n"));
            Dafny.ISequence<Dafny.Rune> _533_args;
            _533_args = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("");
            BigInteger _534_i;
            _534_i = BigInteger.Zero;
            while ((_534_i) < (_524_arity)) {
              if ((_534_i).Sign == 1) {
                _533_args = Dafny.Sequence<Dafny.Rune>.Concat(_533_args, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", "));
              }
              _533_args = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_533_args, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("arg")), DCOMP.__default.natToString(_534_i));
              _534_i = (_534_i) + (BigInteger.One);
            }
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("move |")), _533_args), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("| {\n"));
            s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("callTarget.")), _527_field), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(")), _533_args), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")\n"));
            s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("}\n"));
            s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("}"));
          }
        ...
        DAST._IExpression _535___mcc_h37 = _source19.dtor_expr;
        BigInteger _536___mcc_h38 = _source19.dtor_index;
        BigInteger _537_idx = _536___mcc_h38;
        DAST._IExpression _538_on = _535___mcc_h37;
        {
          Dafny.ISequence<Dafny.Rune> _539_onString;
          bool _540___v44;
          bool _541_tupErased;
          ...
          DCOMP.COMP.GenExpr(_538_on, @params, false, out _out197, out _out198, out _out199, out _out200);
          _539_onString = _out197;
          _540___v44 = _out198;
          _541_tupErased = _out199;
          _542_recIdents = _out200;
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _539_onString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(").")), DCOMP.__default.natToString(_537_idx));
          if (mustOwn) {
          ...
          isErased = _541_tupErased;
          readIdents = _542_recIdents;
        }
      } else if (_source19.is_Call) {
        DAST._IExpression _543___mcc_h39 = _source19.dtor_on;
        Dafny.ISequence<Dafny.Rune> _544___mcc_h40 = _source19.dtor_name;
        Dafny.ISequence<DAST._IType> _545___mcc_h41 = _source19.dtor_typeArgs;
        Dafny.ISequence<DAST._IExpression> _546___mcc_h42 = _source19.dtor_args;
        Dafny.ISequence<DAST._IExpression> _547_args = _546___mcc_h42;
        Dafny.ISequence<DAST._IType> _548_typeArgs = _545___mcc_h41;
        Dafny.ISequence<Dafny.Rune> _549_name = _544___mcc_h40;
        DAST._IExpression _550_on = _543___mcc_h39;
        {
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements();
          Dafny.ISequence<Dafny.Rune> _551_typeArgString;
          _551_typeArgString = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("");
          if ((new BigInteger((_548_typeArgs).Count)) >= (BigInteger.One)) {
            BigInteger _552_typeI;
            _552_typeI = BigInteger.Zero;
            _551_typeArgString = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::<");
            while ((_552_typeI) < (new BigInteger((_548_typeArgs).Count))) {
              if ((_552_typeI).Sign == 1) {
                _551_typeArgString = Dafny.Sequence<Dafny.Rune>.Concat(_551_typeArgString, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", "));
              }
              Dafny.ISequence<Dafny.Rune> _553_typeString;
              Dafny.ISequence<Dafny.Rune> _out201;
              _out201 = DCOMP.COMP.GenType((_548_typeArgs).Select(_552_typeI), false, false);
              _553_typeString = _out201;
              _551_typeArgString = Dafny.Sequence<Dafny.Rune>.Concat(_551_typeArgString, _553_typeString);
              _552_typeI = (_552_typeI) + (BigInteger.One);
            }
            _551_typeArgString = Dafny.Sequence<Dafny.Rune>.Concat(_551_typeArgString, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(">"));
          }
          Dafny.ISequence<Dafny.Rune> _554_argString;
          _554_argString = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("");
          BigInteger _555_i;
          _555_i = BigInteger.Zero;
          while ((_555_i) < (new BigInteger((_547_args).Count))) {
            if ((_555_i).Sign == 1) {
              _554_argString = Dafny.Sequence<Dafny.Rune>.Concat(_554_argString, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", "));
            }
            Dafny.ISequence<Dafny.Rune> _556_argExpr;
            bool _557_isOwned;
            bool _558_argErased;
            Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _559_argIdents;
            Dafny.ISequence<Dafny.Rune> _out202;
            bool _out203;
            bool _out204;
            Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _out205;
            DCOMP.COMP.GenExpr((_547_args).Select(_555_i), @params, false, out _out202, out _out203, out _out204, out _out205);
            _556_argExpr = _out202;
            _557_isOwned = _out203;
            _558_argErased = _out204;
            _559_argIdents = _out205;
            if (_557_isOwned) {
              _556_argExpr = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&"), _556_argExpr);
            }
            _554_argString = Dafny.Sequence<Dafny.Rune>.Concat(_554_argString, _556_argExpr);
            readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(readIdents, _559_argIdents);
            _555_i = (_555_i) + (BigInteger.One);
          }
          Dafny.ISequence<Dafny.Rune> _560_enclosingString;
          bool _561___v45;
          bool _562___v46;
          ...
          DCOMP.COMP.GenExpr(_550_on, @params, false, out _out206, out _out207, out _out208, out _out209);
          _560_enclosingString = _out206;
          _561___v45 = _out207;
          _562___v46 = _out208;
          _563_recIdents = _out209;
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(readIdents, _563_recIdents);
          DAST._IExpression _source22 = _550_on;
          if (_source22.is_Literal) {
            DAST._ILiteral _564___mcc_h56 = _source22.dtor_Literal_a0;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_Ident) {
            Dafny.ISequence<Dafny.Rune> _565___mcc_h58 = _source22.dtor_Ident_a0;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_Companion) {
            Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _566___mcc_h60 = _source22.dtor_Companion_a0;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(_560_enclosingString, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::"));
            }
          } else if (_source22.is_Tuple) {
            Dafny.ISequence<DAST._IExpression> _567___mcc_h62 = _source22.dtor_Tuple_a0;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_New) {
            Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _568___mcc_h64 = _source22.dtor_path;
            Dafny.ISequence<DAST._IExpression> _569___mcc_h65 = _source22.dtor_args;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_NewArray) {
            Dafny.ISequence<DAST._IExpression> _570___mcc_h68 = _source22.dtor_dims;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_DatatypeValue) {
            Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _571___mcc_h70 = _source22.dtor_path;
            Dafny.ISequence<Dafny.Rune> _572___mcc_h71 = _source22.dtor_variant;
            bool _573___mcc_h72 = _source22.dtor_isCo;
            Dafny.ISequence<_System._ITuple2<Dafny.ISequence<Dafny.Rune>, DAST._IExpression>> _574___mcc_h73 = _source22.dtor_contents;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_SubsetUpgrade) {
            DAST._IExpression _575___mcc_h78 = _source22.dtor_value;
            DAST._IType _576___mcc_h79 = _source22.dtor_typ;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_SubsetDowngrade) {
            DAST._IExpression _577___mcc_h82 = _source22.dtor_value;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_SeqValue) {
            Dafny.ISequence<DAST._IExpression> _578___mcc_h84 = _source22.dtor_elements;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_SetValue) {
            Dafny.ISequence<DAST._IExpression> _579___mcc_h86 = _source22.dtor_elements;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
            ...
            DAST._IExpression _580___mcc_h88 = _source22.dtor_cond;
            DAST._IExpression _581___mcc_h89 = _source22.dtor_thn;
            DAST._IExpression _582___mcc_h90 = _source22.dtor_els;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_UnOp) {
            DAST._IUnaryOp _583___mcc_h94 = _source22.dtor_unOp;
            DAST._IExpression _584___mcc_h95 = _source22.dtor_expr;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_BinOp) {
            Dafny.ISequence<Dafny.Rune> _585___mcc_h98 = _source22.dtor_op;
            DAST._IExpression _586___mcc_h99 = _source22.dtor_left;
            DAST._IExpression _587___mcc_h100 = _source22.dtor_right;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_Select) {
            DAST._IExpression _588___mcc_h104 = _source22.dtor_expr;
            Dafny.ISequence<Dafny.Rune> _589___mcc_h105 = _source22.dtor_field;
            bool _590___mcc_h106 = _source22.dtor_onDatatype;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_SelectFn) {
            DAST._IExpression _591___mcc_h110 = _source22.dtor_expr;
            Dafny.ISequence<Dafny.Rune> _592___mcc_h111 = _source22.dtor_field;
            bool _593___mcc_h112 = _source22.dtor_onDatatype;
            bool _594___mcc_h113 = _source22.dtor_isStatic;
            BigInteger _595___mcc_h114 = _source22.dtor_arity;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_TupleSelect) {
            DAST._IExpression _596___mcc_h120 = _source22.dtor_expr;
            BigInteger _597___mcc_h121 = _source22.dtor_index;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_Call) {
            DAST._IExpression _598___mcc_h124 = _source22.dtor_on;
            Dafny.ISequence<Dafny.Rune> _599___mcc_h125 = _source22.dtor_name;
            Dafny.ISequence<DAST._IType> _600___mcc_h126 = _source22.dtor_typeArgs;
            Dafny.ISequence<DAST._IExpression> _601___mcc_h127 = _source22.dtor_args;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_Lambda) {
            Dafny.ISequence<DAST._IFormal> _602___mcc_h132 = _source22.dtor_params;
            DAST._IType _603___mcc_h133 = _source22.dtor_retType;
            Dafny.ISequence<DAST._IStatement> _604___mcc_h134 = _source22.dtor_body;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_IIFE) {
            Dafny.ISequence<Dafny.Rune> _605___mcc_h138 = _source22.dtor_name;
            DAST._IType _606___mcc_h139 = _source22.dtor_typ;
            DAST._IExpression _607___mcc_h140 = _source22.dtor_value;
            DAST._IExpression _608___mcc_h141 = _source22.dtor_iifeBody;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_Apply) {
            DAST._IExpression _609___mcc_h146 = _source22.dtor_expr;
            Dafny.ISequence<DAST._IExpression> _610___mcc_h147 = _source22.dtor_args;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else if (_source22.is_TypeTest) {
            DAST._IExpression _611___mcc_h150 = _source22.dtor_on;
            Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _612___mcc_h151 = _source22.dtor_dType;
            Dafny.ISequence<Dafny.Rune> _613___mcc_h152 = _source22.dtor_variant;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          } else {
            DAST._IType _614___mcc_h156 = _source22.dtor_typ;
            {
              _560_enclosingString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("("), _560_enclosingString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")."));
            }
          }
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_560_enclosingString, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("r#")), (_549_name)), _551_typeArgString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(")), _554_argString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
          isOwned = true;
          isErased = false;
        }
      } else if (_source19.is_Lambda) {
        Dafny.ISequence<DAST._IFormal> _615___mcc_h43 = _source19.dtor_params;
        DAST._IType _616___mcc_h44 = _source19.dtor_retType;
        Dafny.ISequence<DAST._IStatement> _617___mcc_h45 = _source19.dtor_body;
        Dafny.ISequence<DAST._IStatement> _618_body = _617___mcc_h45;
        DAST._IType _619_retType = _616___mcc_h44;
        Dafny.ISequence<DAST._IFormal> _620_params = _615___mcc_h43;
        {
          Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _621_paramNames;
          _621_paramNames = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements();
          BigInteger _622_i;
          _622_i = BigInteger.Zero;
          while ((_622_i) < (new BigInteger((_620_params).Count))) {
            _621_paramNames = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.Concat(_621_paramNames, Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(((_620_params).Select(_622_i)).dtor_name));
          ...
          DCOMP.COMP.GenStmts(_618_body, _621_paramNames, true, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(""), out _out210, out _out211);
          _623_recursiveGen = _out210;
          _624_recIdents = _out211;
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements();
          Dafny.ISequence<Dafny.Rune> _625_allReadCloned;
          _625_allReadCloned = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("");
          while (!(_624_recIdents).Equals(Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements())) {
            Dafny.ISequence<Dafny.Rune> _626_next;
            foreach (Dafny.ISequence<Dafny.Rune> _assign_such_that_1 in (_624_recIdents).Elements) {
              _626_next = (Dafny.ISequence<Dafny.Rune>)_assign_such_that_1;
              if ((_624_recIdents).Contains(_626_next)) {
                goto after__ASSIGN_SUCH_THAT_1;
              }
            }
            throw new System.Exception("assign-such-that search produced no value (line 1362)");
          after__ASSIGN_SUCH_THAT_1:;
            if (!((_621_paramNames).Contains(_626_next))) {
              _625_allReadCloned = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_625_allReadCloned, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("let r#")), _626_next), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" = r#")), _626_next), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(".clone();\n"));
              readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(readIdents, Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements(_626_next));
            }
            _624_recIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Difference(_624_recIdents, Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements(_626_next));
          }
          Dafny.ISequence<Dafny.Rune> _627_paramsString;
          _627_paramsString = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("");
          _622_i = BigInteger.Zero;
          while ((_622_i) < (new BigInteger((_620_params).Count))) {
            if ((_622_i).Sign == 1) {
              _627_paramsString = Dafny.Sequence<Dafny.Rune>.Concat(_627_paramsString, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", "));
            }
            Dafny.ISequence<Dafny.Rune> _628_typStr;
            Dafny.ISequence<Dafny.Rune> _out212;
            _out212 = DCOMP.COMP.GenType(((_620_params).Select(_622_i)).dtor_typ, false, true);
            _628_typStr = _out212;
            _627_paramsString = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(_627_paramsString, ((_620_params).Select(_622_i)).dtor_name), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(": &")), _628_typStr);
            _622_i = (_622_i) + (BigInteger.One);
          }
          Dafny.ISequence<Dafny.Rune> _629_retTypeGen;
          Dafny.ISequence<Dafny.Rune> _out213;
          _out213 = DCOMP.COMP.GenType(_619_retType, false, true);
          _629_retTypeGen = _out213;
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::FunctionWrapper({\n"), _625_allReadCloned), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::std::boxed::Box::new(move |")), _627_paramsString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("| -> ")), _629_retTypeGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" {\n")), _623_recursiveGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n})})"));
          isOwned = true;
          isErased = true;
        }
      } else if (_source19.is_IIFE) {
        Dafny.ISequence<Dafny.Rune> _630___mcc_h46 = _source19.dtor_name;
        DAST._IType _631___mcc_h47 = _source19.dtor_typ;
        DAST._IExpression _632___mcc_h48 = _source19.dtor_value;
        DAST._IExpression _633___mcc_h49 = _source19.dtor_iifeBody;
        DAST._IExpression _634_iifeBody = _633___mcc_h49;
        DAST._IExpression _635_value = _632___mcc_h48;
        DAST._IType _636_tpe = _631___mcc_h47;
        Dafny.ISequence<Dafny.Rune> _637_name = _630___mcc_h46;
        {
          Dafny.ISequence<Dafny.Rune> _638_valueGen;
          bool _639_valueOwned;
          bool _640_valueErased;
          ...
          DCOMP.COMP.GenExpr(_635_value, @params, false, out _out214, out _out215, out _out216, out _out217);
          _638_valueGen = _out214;
          _639_valueOwned = _out215;
          _640_valueErased = _out216;
          _641_recIdents = _out217;
          if (_640_valueErased) {
            Dafny.ISequence<Dafny.Rune> _642_eraseFn;
            _642_eraseFn = ((_639_valueOwned) ? (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("unerase_owned")) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("unerase")));
            _638_valueGen = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::dafny_runtime::DafnyUnerasable::<_>::"), _642_eraseFn), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(")), _638_valueGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(")"));
          }
          readIdents = _641_recIdents;
          Dafny.ISequence<Dafny.Rune> _643_valueTypeGen;
          Dafny.ISequence<Dafny.Rune> _out218;
          _out218 = DCOMP.COMP.GenType(_636_tpe, false, true);
          _643_valueTypeGen = _out218;
          Dafny.ISequence<Dafny.Rune> _644_bodyGen;
          bool _645_bodyOwned;
          bool _646_bodyErased;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _647_bodyIdents;
          Dafny.ISequence<Dafny.Rune> _out219;
          bool _out220;
          bool _out221;
          Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _out222;
          DCOMP.COMP.GenExpr(_634_iifeBody, Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.Concat(@params, ((_639_valueOwned) ? (Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements()) : (Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements((_637_name))))), mustOwn, out _out219, out _out220, out _out221, out _out222);
          _644_bodyGen = _out219;
          _645_bodyOwned = _out220;
          _646_bodyErased = _out221;
          _647_bodyIdents = _out222;
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(readIdents, _647_bodyIdents);
          Dafny.ISequence<Dafny.Rune> _648_eraseFn;
          _648_eraseFn = ((_639_valueOwned) ? (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("unerase_owned")) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("unerase")));
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("{\nlet r#"), (_637_name)), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(": ")), ((_639_valueOwned) ? (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")) : (Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&")))), _643_valueTypeGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" = ")), _638_valueGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(";\n")), _644_bodyGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n}"));
          isOwned = _645_bodyOwned;
          isErased = _646_bodyErased;
        }
      } else if (_source19.is_Apply) {
        DAST._IExpression _649___mcc_h50 = _source19.dtor_expr;
        Dafny.ISequence<DAST._IExpression> _650___mcc_h51 = _source19.dtor_args;
        Dafny.ISequence<DAST._IExpression> _651_args = _650___mcc_h51;
        DAST._IExpression _652_func = _649___mcc_h50;
        {
          Dafny.ISequence<Dafny.Rune> _653_funcString;
          bool _654___v49;
          bool _655_funcErased;
          ...
          DCOMP.COMP.GenExpr(_652_func, @params, false, out _out223, out _out224, out _out225, out _out226);
          _653_funcString = _out223;
          _654___v49 = _out224;
          _655_funcErased = _out225;
          _656_recIdents = _out226;
          readIdents = _656_recIdents;
          Dafny.ISequence<Dafny.Rune> _657_argString;
          _657_argString = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("");
          BigInteger _658_i;
          _658_i = BigInteger.Zero;
          while ((_658_i) < (new BigInteger((_651_args).Count))) {
            if ((_658_i).Sign == 1) {
              _657_argString = Dafny.Sequence<Dafny.Rune>.Concat(_657_argString, Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", "));
            }
            Dafny.ISequence<Dafny.Rune> _659_argExpr;
            bool _660_isOwned;
            bool _661_argErased;
            Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _662_argIdents;
            Dafny.ISequence<Dafny.Rune> _out227;
            bool _out228;
            bool _out229;
            Dafny.ISet<Dafny.ISequence<Dafny.Rune>> _out230;
            DCOMP.COMP.GenExpr((_651_args).Select(_658_i), @params, false, out _out227, out _out228, out _out229, out _out230);
            _659_argExpr = _out227;
            _660_isOwned = _out228;
            _661_argErased = _out229;
            _662_argIdents = _out230;
            if (_660_isOwned) {
              _659_argExpr = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("&"), _659_argExpr);
            }
            _657_argString = Dafny.Sequence<Dafny.Rune>.Concat(_657_argString, _659_argExpr);
            readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.Union(readIdents, _662_argIdents);
            _658_i = (_658_i) + (BigInteger.One);
          }
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(("), _653_funcString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(").0")), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("(")), _657_argString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("))"));
          isOwned = true;
          isErased = false;
        }
      } else if (_source19.is_TypeTest) {
        DAST._IExpression _663___mcc_h52 = _source19.dtor_on;
        Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _664___mcc_h53 = _source19.dtor_dType;
        Dafny.ISequence<Dafny.Rune> _665___mcc_h54 = _source19.dtor_variant;
        Dafny.ISequence<Dafny.Rune> _666_variant = _665___mcc_h54;
        Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _667_dType = _664___mcc_h53;
        DAST._IExpression _668_on = _663___mcc_h52;
        {
          Dafny.ISequence<Dafny.Rune> _669_exprGen;
          bool _670___v50;
          bool _671_exprErased;
          ...
          DCOMP.COMP.GenExpr(_668_on, @params, false, out _out231, out _out232, out _out233, out _out234);
          _669_exprGen = _out231;
          _670___v50 = _out232;
          _671_exprErased = _out233;
          _672_recIdents = _out234;
          Dafny.ISequence<Dafny.Rune> _673_dTypePath;
          Dafny.ISequence<Dafny.Rune> _out235;
          _out235 = DCOMP.COMP.GenPath(_667_dType);
          _673_dTypePath = _out235;
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("matches!("), _669_exprGen), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(".as_ref(), ")), _673_dTypePath), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::r#")), _666_variant), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("{ .. })"));
          isOwned = true;
          isErased = true;
          readIdents = _672_recIdents;
        }
      } else {
        DAST._IType _674___mcc_h55 = _source19.dtor_typ;
        DAST._IType _675_typ = _674___mcc_h55;
        {
          Dafny.ISequence<Dafny.Rune> _676_typString;
          Dafny.ISequence<Dafny.Rune> _out236;
          _out236 = DCOMP.COMP.GenType(_675_typ, false, false);
          _676_typString = _out236;
          s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("<"), _676_typString), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" as std::default::Default>::default()"));
          isOwned = true;
          isErased = false;
          readIdents = Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements();
        }
    ...
    public static Dafny.ISequence<Dafny.Rune> Compile(Dafny.ISequence<DAST._IModule> p) {
      ...
      BigInteger _677_i;
      _677_i = BigInteger.Zero;
      while ((_677_i) < (new BigInteger((p).Count))) {
        Dafny.ISequence<Dafny.Rune> _678_generated = Dafny.Sequence<Dafny.Rune>.Empty;
        Dafny.ISequence<Dafny.Rune> _out237;
        _out237 = DCOMP.COMP.GenModule((p).Select(_677_i), Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements());
        _678_generated = _out237;
        if ((_677_i).Sign == 1) {
          s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n"));
        }
        s = Dafny.Sequence<Dafny.Rune>.Concat(s, _678_generated);
        _677_i = (_677_i) + (BigInteger.One);
      }
      return s;
    }
    public static Dafny.ISequence<Dafny.Rune> EmitCallToMain(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> fullName) {
      ...
      s = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\nfn main() {\n");
      BigInteger _679_i;
      _679_i = BigInteger.Zero;
      while ((_679_i) < (new BigInteger((fullName).Count))) {
        if ((_679_i).Sign == 1) {
          s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("::"));
        }
        s = Dafny.Sequence<Dafny.Rune>.Concat(s, (fullName).Select(_679_i));
        _679_i = (_679_i) + (BigInteger.One);
      }
      s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("();\n}"));
      return s;
    }

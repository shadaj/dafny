...
namespace DAST {
  ...
  public class Newtype : _INewtype {
    ...
    public readonly bool _isNumeric;
    public readonly Dafny.ISequence<DAST._IStatement> _witnessStmts;
    public readonly DAST._IOptional<DAST._IExpression> _witnessExpr;
    public Newtype(Dafny.ISequence<Dafny.Rune> name, DAST._IType @base, bool isNumeric, Dafny.ISequence<DAST._IStatement> witnessStmts, DAST._IOptional<DAST._IExpression> witnessExpr) {
      this._name = name;
      this._base = @base;
    ...
    public _INewtype DowncastClone() {
      ...
      return new Newtype(_name, _base, _isNumeric, _witnessStmts, _witnessExpr);
    }
    public override bool Equals(object other) {
      var oth = other as DAST.Newtype;
      return oth != null && object.Equals(this._name, oth._name) && object.Equals(this._base, oth._base) && this._isNumeric == oth._isNumeric && object.Equals(this._witnessStmts, oth._witnessStmts) && object.Equals(this._witnessExpr, oth._witnessExpr);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      ...
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._isNumeric));
    ...
    public override string ToString() {
      ...
      s += ", ";
      s += Dafny.Helpers.ToString(this._isNumeric);
      s += ", ";
    ...
    private static readonly DAST._INewtype theDefault = create(Dafny.Sequence<Dafny.Rune>.Empty, DAST.Type.Default(), false, Dafny.Sequence<DAST._IStatement>.Empty, DAST.Optional<DAST._IExpression>.Default());
    ...
    public static _INewtype create(Dafny.ISequence<Dafny.Rune> name, DAST._IType @base, bool isNumeric, Dafny.ISequence<DAST._IStatement> witnessStmts, DAST._IOptional<DAST._IExpression> witnessExpr) {
      return new Newtype(name, @base, isNumeric, witnessStmts, witnessExpr);
    }
    public static _INewtype create_Newtype(Dafny.ISequence<Dafny.Rune> name, DAST._IType @base, bool isNumeric, Dafny.ISequence<DAST._IStatement> witnessStmts, DAST._IOptional<DAST._IExpression> witnessExpr) {
      return create(name, @base, isNumeric, witnessStmts, witnessExpr);
    }
      ...
      if (_source16.is_Literal) {
          ...
          while ((_372_i) < (new BigInteger((_367_values).Count))) {
            ...
            if (_368_isCo) {
              ...
              while (!(_378_recIdents).Equals(Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements())) {
                ...
                throw new System.Exception("assign-such-that search produced no value (line 967)");
        ...
        Dafny.ISequence<DAST._IFormal> _584_params = _581___mcc_h43;
        {
          ...
          while (!(_588_recIdents).Equals(Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements())) {
            ...
            throw new System.Exception("assign-such-that search produced no value (line 1301)");

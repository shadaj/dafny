...
namespace DAST {
  ...
  public abstract class BinOp : _IBinOp {
    ...
    private static readonly DAST._IBinOp theDefault = create_Implies();
...
namespace DCOMP {
  ...
  public partial class COMP {
    ...
    public static Dafny.ISequence<Dafny.Rune> GenNewtype(DAST._INewtype c) {
      ...
      s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("}\n"));
      s = Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("}\n"));
      s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("impl ")), _76_constrainedTypeParams), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" ::std::ops::Deref for ")), DCOMP.__default.escapeIdent((c).dtor_name)), _75_typeParams), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" {\n"));
      s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(s, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("type Target = ")), _77_underlyingType), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(";\n"));
      ...
      if (_source5.is_Path) {
        ...
        Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _130_p = _125___mcc_h0;
        {
          ...
          if (_source6.is_Datatype) {
            ...
            {
              if ((_130_p).Equals(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("_System"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("object")))) {
    ...
    public static void GenExpr(DAST._IExpression e, DAST._IOptional<Dafny.ISequence<Dafny.Rune>> selfIdent, Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> @params, bool mustOwn, out Dafny.ISequence<Dafny.Rune> s, out bool isOwned, out bool isErased, out Dafny.ISet<Dafny.ISequence<Dafny.Rune>> readIdents) {
      ...
      if (_source20.is_Literal) {
          ...
          while ((_551_i) < (new BigInteger((_546_values).Count))) {
            ...
            if (_547_isCo) {
              ...
              while (!(_557_recIdents).Equals(Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements())) {
                ...
                throw new System.Exception("assign-such-that search produced no value (line 1207)");
        ...
        DAST._IBinOp _2202_op = _2197___mcc_h32;
        {
          ...
          if (_source72.is_Implies) {
            {
              s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("!("), _2203_left), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(") || ")), _2207_right);
            }
            ...
            {
              s = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("!("), _2207_right), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(".contains(&")), _2203_left), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("))"));
            }
        ...
        Dafny.ISequence<DAST._IFormal> _2767_params = _2762___mcc_h203;
        {
          ...
          while (!(_2771_recIdents).Equals(Dafny.Set<Dafny.ISequence<Dafny.Rune>>.FromElements())) {
            ...
            throw new System.Exception("assign-such-that search produced no value (line 1867)");
